...
class CreateTest: RealmTest() {
    ...
    fun createRealmDictionaryType() {
        runBlocking {
            val config = RealmConfiguration.Builder(setOf(RealmDictionary_Frog::class, RealmDictionary_Friend::class))
                .inMemory()
                .build()
            val realm = Realm.open(config)
            ...
            realm.write {
                ...
                val frogs: RealmResults<RealmDictionary_Frog> = query<RealmDictionary_Frog>().find()
